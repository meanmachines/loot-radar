...
const ICONS = {
  ...
  // Real (if simplified) brand marks, not generic shapes -- a "Sign in
  // with Google/GitHub" button reads as legitimate specifically because
  // it looks like the provider's own mark, not a placeholder.
